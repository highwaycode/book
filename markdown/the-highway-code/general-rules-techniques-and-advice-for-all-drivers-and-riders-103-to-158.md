...
<h2>Signals (rules 103 to 106)</h2>
<h3>Rule 103</h3>
...
<ul><li>give clear signals in plenty of time, having checked it is not misleading to signal at that time</li>
...
<h3>Rule 104</h3>
<p>You should also</p>
<ul><li>watch out for signals given by other road users and proceed only when you are satisfied that it is safe</li>
...
<ul><li>flashing blue lights, headlights or sounding their siren or horn, usually from behind</li>
...
<h2>Other stopping procedures (rules 107 to 112)</h2>
<h3>Rule 107</h3>
...
<ul><li>either from the front requesting you to follow them to a safe place to stop</li>
...
<ul><li>flashing amber lights, usually from behind</li>
<li>directing you to pull over to the side by pointing and/or using the left indicator.</li>
</ul>
<p>You <strong>MUST</strong>
...
use your horn</p>
<ul><li>while stationary on the road</li>
...
<h2>Lighting requirements (rules 113 to 116)</h2>
<h3>Rule 113</h3>
<p>You <strong>MUST</strong>
</p>
<ul><li>ensure all sidelights and rear registration plate lights are lit between sunset and sunrise</li>
...
<ul><li>use any lights in a way which would dazzle or cause discomfort to other road users, including pedestrians, cyclists and horse riders</li>
...
<h3>Rule 115</h3>
<p>You should also</p>
<ul><li>use dipped headlights, or dim-dip if fitted, at night in built-up areas and in dull daytime weather, to ensure that you can be seen</li>
...
<h2>Control of the vehicle (rules 117 to 126)</h2>
<h3>Braking</h3>
<h3>Rule 117</h3>
...
<ul><li>engine braking is eliminated</li>
...
<tbody><tr><td><strong>Type of vehicle</strong>
</td>
<td>mph (km/h)</td>
<td>mph (km/h)</td>
<td>mph (km/h)</td>
...
<tr><td><strong>Cars & motorcycles</strong>
...
<tr><td><strong>Cars towing caravans or trailers</strong>
...
<tr><td><strong>Buses, coaches and minibuses</strong>
...
<tr><td><strong>Goods vehicles</strong>
(not exceeding 7.5 tonnes maximum laden weight)</td>
<td><strong>30</strong>
(48)</td>
<td><strong>50</strong>
(80)</td>
...
<ul><li>the road layout or condition presents hazards, such as bends</li>
...
<ul><li>leave enough space between you and the vehicle in front so that you can pull up safely if it suddenly slows down or stops. The safe rule is never to get closer than the overall stopping distance (see Typical Stopping Distances diagram, shown above)</li>
...
<p></p>
Rule 126: Use a fixed point to help measure a two-second gap <h2>Lines and lane markings on the road (rules 127 to 132)</h2>
...
<ul><li>If the area is bordered by a broken white line, you should not enter the area unless it is necessary and you can see that it is safe to do so.</li>
...
<ul><li>White studs mark the lanes or the middle of the road.</li>
...
<p></p>
Rule 132: Reflective road studs mark the lanes and edge of the carriageway <h2>Multi-lane carriageways (rules 133 to 143)</h2>
...
<ul><li>use the middle lane only for overtaking or turning right. Remember, you have no more right to use the middle lane than a driver coming from the opposite direction</li>
...
be used by</p>
<ul><li>vehicles containing at least the minimum number of people indicated on the traffic signs</li>
...
<ul><li>the left-hand lane when going left</li>
...
<h2>General advice (rules 144 to 158)</h2>
<h3>Rule 144</h3>
<p>You <strong>MUST NOT</strong>
</p>
<ul><li>drive dangerously</li>
...
<ul><li>do not treat speed limits as a target. It is often not appropriate or safe to drive at the maximum speed limit</li>
...
<ul><li>you <strong>MUST NOT</strong>
...
<ul><li>loud music (this may mask other sounds)</li>
...
You should</p>
<ul><li>reduce the distance between you and the vehicle ahead to maintain traffic flow</li>
...
<ul><li>vehicles emerging from junctions or driveways</li>
